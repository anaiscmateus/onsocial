        ...
        <section className="grid lg:grid-cols-12 gap-8 max-w-7xl items-center">
          <section className="lg:col-span-7">
            <p className="text-2xl tracking-wider mb-5">
              ...
              is <span className="font-bold italic">revolutionizing</span>{" "}
              social media for small businesses, taking the weight off of
              business owners&lsquo; shoulders so they can{" "}
            ...
            <p className="text-2xl tracking-wider">
              ...
              . They are particularly adept at utilizing analytics and trend
              ...
              and Later, as well as Meta Business Suite,{" "}
